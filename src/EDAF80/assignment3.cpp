...
edaf80::Assignment3::run()
{
    ...
    auto skybox_cubemap_texture = bonobo::loadTextureCubeMap( cubemap_texture_path + "posx.jpg",
	...
	auto sphere_texture = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_coll1_2k.jpg"));
	auto sphere_specular_map = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_rough_2k.jpg"));
	auto sphere_normal_map = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_nor_2k.jpg"));
	...
	skybox.add_texture("cube_map", skybox_cubemap_texture, GL_TEXTURE_CUBE_MAP);
	...
	demo_sphere.add_texture("sphere_texture", sphere_texture, GL_TEXTURE_2D);
	demo_sphere.add_texture("specular_map", sphere_specular_map, GL_TEXTURE_2D);
	demo_sphere.add_texture("normal_map", sphere_normal_map, GL_TEXTURE_2D);
